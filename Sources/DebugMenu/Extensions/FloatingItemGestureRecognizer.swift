...
public class FloatingItemGestureRecognizer: UIPanGestureRecognizer {
    ...
    @objc private func pan(_ gesture: UIPanGestureRecognizer) {
        ...
        case .began:
            ...
            let gap = CGPoint(x: targetView.center.x - location.x, y: targetView.center.y - location.y)
            self.gestureGap = gap
        ...
        case .ended:
            ...
            let initialVelocity = initialAnimationVelocity(for: velocity, from: self.view!.center, to: destination)
