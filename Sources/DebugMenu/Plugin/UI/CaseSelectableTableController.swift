...
public class CaseSelectableTableController<T: CaseIterable & RawRepresentable>: UITableViewController where T.RawValue: Equatable {
    ...
    public override func viewDidLoad() {
        super.viewDidLoad()
        selectedIndex = IndexPath(row: T.allCases.enumerated().first(where: { $1 == currentValue })?.offset ?? 0, section: 0)
